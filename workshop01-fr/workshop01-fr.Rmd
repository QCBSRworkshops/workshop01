...
#### 3. Manipulate basic R objects

#### 4. Install and use an R package
...
- Structure de base en R; tous les autres objets sont formés à partir d'un ou plusieurs vecteurs.
...
- Plusieurs fonctions statistiques (e.g. régression) utilisent des dataframes.
