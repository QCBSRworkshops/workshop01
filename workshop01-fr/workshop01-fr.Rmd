...
![:scale 90%](images/Type_of_data_structure_in_R.pdf)
---
# Types de structures de données en R

`vecteur` 
- Combinaison d'éléments du même type de données. 
- Structure de base en R; tous les objets sont formés à partir d'un ou plusieurs vecteurs.
...
.comment[Le symbole de deux-points `:` est utilisé pour combiner toutes les valeurs entre le premier et le deuxième nombre fournis. `c(1:5)` est équivalent à `c(1, 2, 3, 4, 5)`]
