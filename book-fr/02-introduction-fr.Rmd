...
![logo RStudio](images//Rstudio.png){width="200"}
...
![La console RStudio ](images//Rstudioconsole_fleche.png){width="800"}
...
Pour résoudre une *erreur*, les internets sont vontre meilleur ami. 
